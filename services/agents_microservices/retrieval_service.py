...
app = FastAPI(title="Retrieval Agent Microservice", version="3.0.0")
agent = CurriculumRAGAgent(name="CurriculumRAGAgent")
...
@app.get("/health")
async def health():
    return {"status": "healthy", "service": "RetrievalAgent", "port": 8002}
