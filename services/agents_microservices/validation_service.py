...
from agents.validator_agent.agents.agent import ValidationAgent

app = FastAPI(title="Validation Agent Microservice", version="3.0.0")
agent = ValidationAgent(name="ValidationAgent")
...
@app.get("/health")
async def health():
    return {"status": "healthy", "service": "ValidationAgent", "port": 8001}
