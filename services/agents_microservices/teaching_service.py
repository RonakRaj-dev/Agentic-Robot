...
from agents.teaching_agent.agents.agent import TeachingAgent

app = FastAPI(title="Teaching Agent Microservice", version="3.0.0")
agent = TeachingAgent(name="TeachingAgent")
...
@app.get("/health")
async def health():
    return {"status": "healthy", "service": "TeachingAgent", "port": 8003}
